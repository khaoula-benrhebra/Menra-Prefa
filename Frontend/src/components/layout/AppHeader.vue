    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <nav class="hidden md:flex space-x-8">
          <router-link 
            to="/" 
            class="text-menara-gray hover:text-menara-red transition-colors font-medium"
            :class="{ 'text-menara-red': $route.path === '/' }"
          >
            Accueil
          </router-link>
          <a href="#" class="text-menara-gray hover:text-menara-red transition-colors font-medium">
            Nos Produits
          </a>
          <router-link 
            to="/register" 
        ...
        <div class="md:hidden">
          <button 
            ...
            class="text-menara-gray hover:text-menara-red p-2"
          >
      ...
      <div v-if="isMobileMenuOpen" class="md:hidden pb-4">
        <div class="flex flex-col space-y-2">
          <router-link 
            to="/" 
            class="text-menara-gray hover:text-menara-red py-2 font-medium"
            :class="{ 'text-menara-red': $route.path === '/' }"
